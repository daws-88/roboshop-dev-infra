...
resource "aws_route53_record" "mongodb" {
  zone_id = var.zone_id
  name    = "mongodb-${var.environment}.daws88s.fun" #mongodb-dev.daws88s.fun
  type    = "A"
  ttl     = 2
...
resource "aws_route53_record" "redis" {
  zone_id = var.zone_id
  name    = "redis-${var.environment}.daws88s.fun" 
  type    = "A"
  ttl     = 2
...
resource "aws_route53_record" "rabbitmq" {
  zone_id = var.zone_id
  name    = "rabbitmq-${var.environment}.daws88s.fun" 
  type    = "A"
  ttl     = 2
...
resource "aws_route53_record" "mysql" {
  zone_id = var.zone_id
  name    = "mysql-${var.environment}.daws88s.fun" 
  type    = "A"
  ttl     = 2
